...
状態：B-08まで承認済み。B-09の受渡し・Review Protocol案はHuman Review待ち。
...
現在の作業は[B-09 / Issue #19](https://github.com/tanakakeisuke-github/tOS/issues/19)です。基準commitと入力は担当Issueを確認します。成果物はDraft PRでHuman Reviewを待ち、Doneや後続Issueの開始を自動的に決めません。
