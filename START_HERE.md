...
状態：B-04までの入口とKnowledgeの読み順は承認済み。B-05の作業案はHuman Review待ち。
...
現在の作業は[B-05 / Issue #11](https://github.com/tanakakeisuke-github/tOS/issues/11)です。基準commitと入力は担当Issueを確認します。成果物はDraft PRでHuman Reviewを待ち、Doneや後続Issueの開始を自動的に決めません。
