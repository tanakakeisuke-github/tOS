...
直近の完了対象は[B-12 / Issue #25](https://github.com/tanakakeisuke-github/tOS/issues/25)です。[R5結果](outcomes/b12-r5/README.md)と受入記録を参照してください。次の制作・改善Taskは目的・範囲・入力・受入条件を具体化し、個別のReady承認を経て開始します。
