...
状態：B-06まで承認済み。B-07のActor Model案はHuman Review待ち。
...
現在の作業は[B-07 / Issue #15](https://github.com/tanakakeisuke-github/tOS/issues/15)です。基準commitと入力は担当Issueを確認します。成果物はDraft PRでHuman Reviewを待ち、Doneや後続Issueの開始を自動的に決めません。
