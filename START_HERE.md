...
状態：B-07まで承認済み。B-08の入口Protocol案はHuman Review待ち。
...
現在の作業は[B-08 / Issue #17](https://github.com/tanakakeisuke-github/tOS/issues/17)です。基準commitと入力は担当Issueを確認します。成果物はDraft PRでHuman Reviewを待ち、Doneや後続Issueの開始を自動的に決めません。
