...
root=pathlib.Path('/private/tmp/tos-b12-explicit-controls')
...
args+=['-c','skills.config=['+','.join('{path="/Users/keisuketanaka/.codex/skills/.system/'+n+'",enabled=false}' for n in ['imagegen','openai-docs','plugin-creator','skill-creator','skill-installer'])+']']
