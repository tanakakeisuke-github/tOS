...
| OQ-10 | 分解案はPR #2のHuman Reviewで承認済み。個別候補は着手時に粒度を確認する | B-01〜B-10完了、B-11のみ着手承認済み。B-12は個別承認待ち |
