...
| OQ-10 | 分解案はPR #2のHuman Reviewで承認済み。個別候補は着手時に粒度を確認する | B-01〜B-04完了、B-05のみ着手承認済み。B-06以降は個別承認待ち |
